...
function normalizeDate(date: Date): Date {
	// If we have timezone info, we can be more precise
	// Otherwise, construct date from components to avoid timezone issues
	const year = date.getFullYear();
	const month = date.getMonth();
	const day = date.getDate();

	// Create new date in UTC at start of day
